    ...
    <div className="aboutApp floatTab dpShad">
      <div className="content p-6">
        ...
        <p>
          ...
          <a
            target="_blank"
            href="https://github.com/digitalaga/WindowsSimulator/blob/master/LICENSE"
            rel="noreferrer"
          >
        ...
        <p className="pl-4">
          {t("about.contact")} :&nbsp;
          <a target="_blank" href="mailto:sakshamsgsg@gmail.com" rel="noreferrer">
            sakshamsgsg@gmail.com
          </a>
        </p>
